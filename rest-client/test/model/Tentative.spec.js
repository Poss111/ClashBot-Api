...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClashBotRestClient&#x3D;projectVersion&#x3D;100.Tentative();
  });
  ...
  describe('Tentative', function() {
    it('should create an instance of Tentative', function() {
      // uncomment below and update the code to test Tentative
      //var instance = new ClashBotRestClient&#x3D;projectVersion&#x3D;100.Tentative();
      //expect(instance).to.be.a(ClashBotRestClient&#x3D;projectVersion&#x3D;100.Tentative);
    });
    ...
    it('should have the property tentativePlayers (base name: "tentativePlayers")', function() {
      // uncomment below and update the code to test the property tentativePlayers
      //var instance = new ClashBotRestClient&#x3D;projectVersion&#x3D;100.Tentative();
      //expect(instance).to.be();
    });
